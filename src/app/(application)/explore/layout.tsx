  ...
  return (
    <div className="mx-auto w-full max-w-7xl space-y-12 px-4 py-8 md:px-8 md:py-12">
      ...
      <section className="grid grid-cols-12 gap-4">
        <section className="bg-background sticky-below-header sticky z-40 col-span-full -my-2 flex self-start overflow-x-auto py-2 md:top-20 md:col-span-3 md:my-0 md:flex-col md:py-0">
          <Suspense>
            <FilterSection />
          </Suspense>
        </section>
